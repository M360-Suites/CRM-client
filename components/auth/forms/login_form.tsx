		...
		>
			<div className="flex flex-col gap-3 w-full">
				...
				<Link
					...
					className="text-[#00B3A6] text-sm/[20px] self-end font-normal"
				>
					Forgot password?
				</Link>
			</div>
			...
			<div className="flex flex-row items-center gap-2 justify-center">
				<span className="text-[#334155] font-normal text-base/[20px]">
					Don&apos;t have an account?
				</span>
				<Link
					href="/register"
					className="text-[#00B3A6] text-sm/[20px] font-medium"
				>
					Sign up
				</Link>
			</div>
