...
export default function HalfSide() {
	...
	return (
		<div
			className={`lg:w-1/2 max-lg:hidden bg-[#E6F2FF4D] flex flex-col justify-center xl:py-8 py-4 px-5 xl:px-12 rounded-[16px] gap-15 lg:gap-10 flex-1`}
		>
			<div
			...
			{(value.type === "login" || value.type === "register") && (
				<div className="flex flex-col gap-4 items-center justify-center w-full">
					<h1 className="text-[38px]/[120%] text-[#334155] tracking-tight font-medium text-center">
						{value.title}
					</h1>
					<p className="text-base text-center font-normal text-[#334155]">
						{value.description}
					</p>
				</div>
			)}
