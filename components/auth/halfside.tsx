...
export default function HalfSide() {
	...
	return (
		<div
			className={`lg:w-1/2 max-lg:hidden h-full bg-[#FFF6EC] flex flex-col justify-center xl:py-8 py-4  px-5 xl:px-12 rounded-[16px] gap-15 lg:gap-10 ${value.type === "login" || value.type === "register" ? "min-h-[95svh] " : "min-h-[95svh]"} `}
		>
			<div
