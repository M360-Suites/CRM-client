			...
			<div className="grid xl:grid-cols-6 lg:grid-cols-4 gap-2 max-lg:grid-cols-3 max-sm:grid-cols-2 max-xs:grid-cols-1 w-full">
				{stages?.map((stage) => {
					...
					return (
						<div
							key={stage.id}
							className="flex flex-col border border-[#D9E1E8] rounded-md flex-1 min-w-0"
						>
							<div className="border-b border-b-[#D9E1E8]  bg-white rounded-t-md  p-4 max-md:p-2 flex flex-col gap-4">
										...
										<div className="flex flex-row items-center gap-3">
											<CustomPopover
												trigger={
													<UserRoundPlus
														size={16}
														className="cursor-pointer hover:text-[#00B3A6]"
													/>
												}
												title="Team members"
											>
												<div className="flex flex-col gap-1 items-start justify-start bg-transparent min-w-30">
																			...
																			{assignedUsers.some(
																				...
																				>
																					...
																					deleteVariables?.userId ===
																						...
																						<Trash2 className="text-foundation-error-6 cursor-pointer text-xs" />
																					)}
																				</button>
																			)}
																		</div>
														...
														.map(
															(
																...
																<span
																	...
																	className={`inline-flex h-6 w-6 py-2 items-center justify-center font-semibold rounded-full bg-[#00B3A6] border border-[#00B3A6]/80 p-1.5 text-[10px] text-white ${index > 0 ? "-ml-2 top-4" : ""}`}
																	style={{
																		zIndex:
