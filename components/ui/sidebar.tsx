		...
		return (
			<Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
				...
				>
					...
					<div className="flex h-full w-full font-inter flex-col bg-sidebar">
						{children}
					</div>
				</SheetContent>
			</Sheet>
...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
	return (
		<div
			...
			className={cn(
				"no-scrollbar flex min-h-0 flex-1 flex-col gap-0 overflow-auto group-data-[collapsible=icon]:overflow-hidden bg-sidebar",
				className,
			)}
			{...props}
		/>
